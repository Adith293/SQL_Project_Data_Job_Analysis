...
![Visual Representation of Average Salary Distribution for the Top 10 Paying Data Analyst Jobs](assets/top_payingjobs_visuals.png)
...
| Skills Required | Average Salary |
| :--- | :---: |
| PySpark | $208,172.25 |
...
# What I Learned
- 🗄️ Built a strong foundation in **SQL**, covering both fundamental and advanced concepts used in real-world data analysis workflows.
- 🔗 Gained hands-on experience with **JOINs, CTEs, subqueries, aggregations, and arithmetic operations** to combine, transform, and analyze data efficiently.
- 📊 Strengthened my ability to **extract actionable insights from data** by solving business-focused problems using complex SQL queries and analytical thinking.
- 🧹 Developed practical skills in **data cleaning, data validation, and handling large datasets**, ensuring accuracy and reliability in analysis.
- 🚀 Improved my overall **data analytics and problem-solving capabilities**, learning how to structure queries, optimize workflows, and communicate findings through data-driven projects.
